# MAD BRAINS - Simple Artificial Neural Network that can represent a logical function (AND or OR) or a linear function of the structure "y = ax + b" after its learning process is complete
